...
public interface IActionProvider {
     ...
     * @param pCurrentBranch ID of the current branch
     * @param pTargetBranch  ID of the branch that should get merged into the current one
    ...
    /**
     * @param pRepository              Observable with the current Repository
     * @param pSelectedFilesObservable Observable with the list of selected IFileChangeTypes. Obtainable by i.e. the {@see ObservableTable}
     ...
     * @param pRepository Observable with the current Repository
     * @param pSelectedFilesObservable Observable with the list of selected IFileChangeTypes. Obtainable by i.e. the {@see ObservableTable}
     * @return Action whose actionPerformed method adds a file/changes in a file to the staging. Also {@see resetFilesAction}
     */
